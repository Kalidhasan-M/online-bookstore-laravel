            ...
            <div class="card-body">
                <form action="{{ route('admin.books.update', $book) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('stock_quantity') is-invalid @enderror" 
                                       id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', $book->stock_quantity) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        @if($book->cover_image)
                            <div class="mb-2">
                                <img src="{{ asset($book->cover_image) }}" alt="Current cover" 
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <strong>Created:</strong> {{ $book->created_at->format('M j, Y') }}
                    </li>
                    <li class="mb-2">
                        <strong>Last Updated:</strong> {{ $book->updated_at->format('M j, Y') }}
                    </li>
                    <li class="mb-2">
